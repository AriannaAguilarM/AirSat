...
<head>
    <meta charset="UTF-8">
    <title>Múltiples Lanzamientos - AirSat</title>
    <style>
        body { 
...
<body>
    <div class="header">
        <h1 style="margin: 0; font-size: 16px;">Reporte de Múltiples Lanzamientos - AirSat</h1>
        <p style="margin: 5px 0; font-size: 12px;">Total de lanzamientos: <?= count($lanzamientos) ?></p>
    ...
    $totalLanzamientos = count($lanzamientos);
    foreach ($lanzamientos as $index => $lanzamiento): 
    ?>
        <div class="lanzamiento-section <?= ($index + 1) < $totalLanzamientos ? 'page-break' : 'no-page-break' ?>">
            <div class="lanzamiento-header">
                Lanzamiento ID: <?= $lanzamiento['id'] ?> - <?= $lanzamiento['descripcion'] ?>
            </div>
            ...
            <div class="info-section">
                ...
                <table style="width: 100%; font-size: 9px;">
                    <tr>
                        ...
                        <td style="width: 25%;"><strong>Lecturas:</strong> <?= count($lanzamiento['lecturas']) ?></td>
                    </tr>
                    <tr>
            ...
            <?php if (!empty($lanzamiento['lecturas'])): ?>
                ...
                <table class="table stats-table">
                    ...
                    <tbody>
                        ...
                        $temperaturas = array_column($lanzamiento['lecturas'], 'temperatura');
                        $humedades = array_column($lanzamiento['lecturas'], 'humedad');
                        $presiones = array_column($lanzamiento['lecturas'], 'presion_atmosferica');
                        $alturas_abs = array_column($lanzamiento['lecturas'], 'altura_absoluta');
                        $alturas_rel = array_column($lanzamiento['lecturas'], 'altura_relativa');
                        $aqis = array_column($lanzamiento['lecturas'], 'AQI');
                        $tvocs = array_column($lanzamiento['lecturas'], 'TVOC');
                        $eco2s = array_column($lanzamiento['lecturas'], 'eCO2');
                        $pm1s = array_column($lanzamiento['lecturas'], 'PM1');
                        $pm25s = array_column($lanzamiento['lecturas'], 'PM2_5');
                        $pm10s = array_column($lanzamiento['lecturas'], 'PM10');
                        $axs = array_column($lanzamiento['lecturas'], 'AX');
                        $ays = array_column($lanzamiento['lecturas'], 'AY');
                        $azs = array_column($lanzamiento['lecturas'], 'AZ');
                        $gxs = array_column($lanzamiento['lecturas'], 'GX');
                        $gys = array_column($lanzamiento['lecturas'], 'GY');
                        $gzs = array_column($lanzamiento['lecturas'], 'GZ');
                        ?>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php foreach ($lanzamiento['lecturas'] as $lectura): ?>
                            <tr>
            ...
            <div class="lanzamiento-footer">
                <p>Fin del Reporte - Lanzamiento ID: <?= $lanzamiento['id'] ?></p>
            </div>
        </div>
    ...
    <div class="final-footer">
        <p><strong>Sistema AirSat - Reporte completo de <?= count($lanzamientos) ?> lanzamientos</strong></p>
